...
export LEROBOT_ROOT
export RUNTIME_CONFIG="$LEROBOT_ROOT/hybrid_runtime.json"
...
export DEBUG_OBSERVATION_DIR="$LEROBOT_ROOT/debug/client_camera_inputs"
export DEBUG_OBSERVATION_LIMIT=1

bash scripts/run_smolvla_red_observe_inference.sh \
