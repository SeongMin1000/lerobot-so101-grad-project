...
RUNTIME_CONFIG="${RUNTIME_CONFIG:-$LEROBOT_ROOT/hybrid_runtime.json}"
...
DEBUG_OBSERVATION_DIR="${DEBUG_OBSERVATION_DIR:-$LEROBOT_ROOT/debug/client_camera_inputs}"
...
require_path "$LEROBOT_ROOT/src/lerobot/async_inference/hybrid_goto_both_pose.py"
