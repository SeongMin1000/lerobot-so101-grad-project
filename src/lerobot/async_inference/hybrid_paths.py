...
DEFAULT_RUNTIME_NAME = "hybrid_runtime.json"
DEFAULT_DETECTOR_NAME = "configs/opencv_detector.json"
...
def lerobot_root() -> Path:
    ...
    if configured:
        ...
        # .../lerobot/src/lerobot/async_inference/hybrid_paths.py
...
def check_paths() -> int:
    ...
    duplicate = Path(__file__).resolve().parent / DEFAULT_RUNTIME_NAME
