...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "reference_image": "target_empty_reference.png",
...
class TargetOccupancyVerifier:
    def __init__(
        ...
        *,
        ...
        reference_path = Path(str(cfg.get("reference_image", "target_empty_reference.png")))
...
def main() -> int:
    ...
    parser.add_argument("--config", default="target_verifier.json")
    parser.add_argument(
        "--layout",
