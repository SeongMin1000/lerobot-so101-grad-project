...
1. Move follower and leader to ``poses.observe`` in ``hybrid_runtime.json``.
...
Install this file at:
    ...
    ~/lerobot/src/lerobot/async_inference/smolvla_record_observe_return.py

Run it with:

    python -m lerobot.async_inference.smolvla_record_observe_return ...
"""
...
from lerobot.async_inference.hybrid_goto_both_pose import (
    find_target_pose,
    load_runtime,
    move_both,
)
...
class RecordConfig(LeRobotRecordConfig):
    ...
    runtime_config: str = "hybrid_runtime.json"
